...
export default function AboutMe() {
  return (
    <AboutContainer id="sobre">
      ...
      <Description>
        Desenvolvedor Front-End com quase <b>3 anos</b> de experiência, sendo <b>2 anos
        como Júnior </b> e <b> 7 meses como Pleno</b>, sempre atuando com React.
        <br />
        <br />
        Atualmente desenvolvo interfaces e ferramentas que automatizam processos
        e aumentam a produtividade de empresas do segmento de crédito
        consignado.
        <br />
        <br />
        Sou apaixonado por criar soluções funcionais, escaláveis e centradas na
        experiencia do usuário, priorizando sempre a praticidade das ferramentas
        desenvolvidas.
      </Description>
